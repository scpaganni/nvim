...
_G.packer_plugins = {
  ...
  ["alpha-nvim"] = {
    ...
    loaded = true,
    path = "/home/sergio/.local/share/nvim/site/pack/packer/start/alpha-nvim",
  ...
  ["nlsp-settings.nvim"] = {
    loaded = true,
    path = "/home/sergio/.local/share/nvim/site/pack/packer/start/nlsp-settings.nvim",
  ...
  ["project.nvim"] = {
    ...
    loaded = true,
    path = "/home/sergio/.local/share/nvim/site/pack/packer/start/project.nvim",
